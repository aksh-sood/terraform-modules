...
|domain_name (required) | Domain name registerd in the DNS service | string |  |
...
|alert_manager_volume_size|PVC size for aleretmanager|string|`"5Gi"`|
...
|ingress_hostname |string|Hostname of the isito ingress created|