...
//TODO: Lambda IAM role to be added here
  # resources_key_user_arns = ["arn:aws:iam::010601972186:role/LambdaExecutionRole", module.kinesis_app.role_arn, var.eks_cluster_role_arn, var.eks_node_role_arn, module.kinesis_firehose.firehose_role_arn]
  ...
  # |
# |  arn:aws:iam::010601972186:role/lambda-execution-role                                                                                         |  lambda-execution-role                                             |
# |  arn:aws:iam::010601972186:role/LambdaExecutionRole   